...
3. Reload the extension, open any page, click **Context**
...
| Still stuck | `python3 main.py` manually, then **Retry** in the side panel |
...
- Saves quotes from the side panel when you highlight text
